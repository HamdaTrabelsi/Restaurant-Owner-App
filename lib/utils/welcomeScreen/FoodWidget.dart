...
Widget search(BuildContext context) {
  return Container(
    ...
    decoration: boxDecoration(
        radius: 50, bgColor: food_white, color: food_colorPrimary),
      ...
      text: TextSpan(
        children: [
          ...
          TextSpan(
              ...
              style: TextStyle(
                  fontSize: textSizeMedium, color: food_textColorSecondary)),
        ],
      ),
    ),
  );
      ...
      children: <Widget>[
        ...
        GestureDetector(
          ...
          child: text(food_lbl_change,
              textColor: food_colorPrimary, fontFamily: fontMedium),
        ),
      ],
    ),
  );
        ...
        text: TextSpan(
          children: [
            ...
            TextSpan(
                text: value,
                style: TextStyle(
                    fontSize: textSizeMedium, color: food_colorPrimary)),
          ],
        ),
      ),
    ),
    ...
    text: TextSpan(
      children: [
        TextSpan(
            text: value,
            style:
                TextStyle(fontSize: textSizeSMedium, color: food_color_green)),
        WidgetSpan(
          child: Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      ...
      child: Container(
        ...
        width: width * 0.23,
        decoration: boxDecoration(
            color: food_textColorPrimary, radius: spacing_control),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Container(
...
Widget mBottom(
    BuildContext context, var gColor1, var gColor2, var value, var tags) {
  var width = MediaQuery.of(context).size.width;
...
Widget mDot() {
  return Container(
      decoration: BoxDecoration(shape: BoxShape.circle, color: food_view_color),
      width: 8,
      height: 8);
}
